			...
			datasets: [
				{
					type: 'line',
					label: 'Cloud low',
					data: props.forecast.map(day => day.data.instant.details?.cloud_area_fraction_low || 0),
				...
				},
				{
					type: 'line',
					label: 'Cloud medium',
					data: props.forecast.map(day => day.data.instant.details?.cloud_area_fraction_medium || 0),
					cubicInterpolationMode: 'monotone',
					borderColor: 'rgba(159, 159, 163, 0.3)',
					backgroundColor: 'rgba(159, 159, 163, 0.3)',
					fill: 'origin',
				...
				},
				{
					type: 'line',
					label: 'Cloud hight',
					data: props.forecast.map(day => day.data.instant.details?.cloud_area_fraction_high || 0),
					cubicInterpolationMode: 'monotone',
					borderColor: 'rgba(159, 159, 163, 0.3)',
					backgroundColor: 'rgba(159, 159, 163, 0.3)',
					fill: 'origin',
				...
				},
				{
					...
					data: props.forecast.map(day => day.data.next_1_hours?.details.precipitation_amount || 0),
					barThickness: 5,
